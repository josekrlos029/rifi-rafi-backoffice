...
export default function CategoriesPage() {
  ...
  const columns: Column<QuestionCategory>[] = [{ header: "Nombre", accessor: "name" }, { header: "Descripción", accessor: "description" }];
  ...
  return (
    <div className="space-y-6">
      ...
      {!isAdmin && (
        <Alert>
          <AlertDescription>Solo ADMIN puede crear, editar o eliminar categorías.</AlertDescription>
        </Alert>
      )}
